class Game_condition:
    ...
    def horizontal_victory(self, pawn_sign):
        first_horizontal_win = [self.grid[0, 0],
                                self.grid[0, 1], self.grid[0, 2]]
        second_horizontal_win = [self.grid[1, 0],
                                 self.grid[1, 1], self.grid[1, 2]]
        third_horizontal_win = [self.grid[2, 0],
    ...
    def vertical_victory(self, pawn_sign):
        first_vertical_win = [self.grid[0, 0],
                              self.grid[1, 0], self.grid[2, 0]]
        second_vertical_win = [self.grid[0, 1],
                               self.grid[1, 1], self.grid[2, 1]]
        third_vertical_win = [self.grid[0, 2],
    ...
    def diagonal_victory(self, pawn_sign):
        first_diagonal_win = [self.grid[0, 0],
                              self.grid[1, 1], self.grid[2, 2]]
        second_diagonal_win = [self.grid[0, 2],
