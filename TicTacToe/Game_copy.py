...
class Game_copy:
    ...
    def random_player_online(self, player_random_array):
        player1_name = ''
        player2_name = ''
        player1_name = choice(player_random_array)
        if player1_name == player_random_array[0]:
            player2_name += player_random_array[1]
        else:
            player2_name = player_random_array[0]
        print(
            f"Premier joueur : {player1_name}, deuxième joueur : {player2_name}")
        array_of_player = [player1_name, player2_name]
        print(array_of_player)
    ...
    def play_online(self):
        ...
        win_player_1 = False
        win_player_2 = False
        array_of_player = self.random_player_online
    ...
    def horizontal_victory(self, pawn_sign):
        first_horizontal_win = [grid.grid[0, 0],
                                grid.grid[0, 1], grid.grid[0, 2]]
        second_horizontal_win = [grid.grid[1, 0],
                                 grid.grid[1, 1], grid.grid[1, 2]]
        third_horizontal_win = [grid.grid[2, 0],
                                grid.grid[2, 1], grid.grid[2, 2]]
        victory = False
    ...
    def vertical_victory(self, pawn_sign):
        first_vertical_win = [grid.grid[0, 0],
                              grid.grid[1, 0], grid.grid[2, 0]]
        second_vertical_win = [grid.grid[0, 1],
                               grid.grid[1, 1], grid.grid[2, 1]]
        third_vertical_win = [grid.grid[0, 2],
                              grid.grid[1, 2], grid.grid[2, 2]]
        victory = False
    ...
    def diagonal_victory(self, pawn_sign):
        first_diagonal_win = [grid.grid[0, 0],
                              grid.grid[1, 1], grid.grid[2, 2]]
        second_diagonal_win = [grid.grid[0, 2],
